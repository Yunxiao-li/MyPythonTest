...
class MainWindow(QtWidgets.QMainWindow, QtWidgets.QApplication):
    def __init__(self, app):
        ...
        reinitAction = QAction('reinit',self)
    ...
    def reinit(self):
        # base setup
        self.renderer, self.frame, self.vtk_widget, self.interactor, self.render_window = self.setup()
        self.brain, self.mask = setup_brain(self.renderer, self.image_name), setup_mask(self.renderer,
                                                                                            self.seg_name)
    ...
    def add_vtk_window_widget(self):
        ...
        object_title = "Vertebrae: {0} (min: {1:.2f}, max: {2:.2f})        Mask: {3}".format(base_brain_file,
    ...
    def add_brain_settings_widget(self):
        brain_group_box = QtWidgets.QGroupBox("Vertebrae Settings")
        brain_group_layout = QtWidgets.QGridLayout()
        #brain_group_layout.addWidget(QtWidgets.QLabel("Vertebrae Threshold"), 0, 0)
        #brain_group_layout.addWidget(QtWidgets.QLabel("Vertebrae Opacity"), 1, 0)
       #brain_group_layout.addWidget(QtWidgets.QLabel("Vertebrae Smoothness"), 2, 0)
        ...
        brain_group_layout.addWidget(self.brain_projection_cb, 1, 0)
        brain_group_layout.addWidget(self.brain_slicer_cb, 1, 1)

...
import sys
sys.path.insert(0, r'C:\Users\liw66\OneDrive - Medtronic PLC\Project\py\VertebraSeg'
                r'\VertebraeSegmentationCode\MedicalDataAugmentationTool-master')
sys.path.insert(0, r'VertebraeSegmentationCode/MedicalDataAugmentationTool-master/tensorflow_train')
